...
@section('title')
Ecommerce - {{ ucfirst($product->name) }}
@endsection
...
<div class="row">
    <div class="col-xl-10 m-auto">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">
                    Details of {{ ucfirst($product->name) }}
                </p>
                                ...
                                @if ($product->hasColors->colors != "")
                                    <div class="row">
                                        @foreach(explode(',', $product->hasColors->colors) as $info) 
                                            <div style="background:{{ str_replace(' ', '', $info) }};width:30px;height:30px;margin-right:5px;"></div>
                                        @endforeach
                                    </div>
                                @endif
                            </td>
        ...
        <div class="text-center">
            <a href="{{ route('products.index') }}" class="btn btn-primary btn-lg text-center">
