    ...
    <div class="col-xl-10 m-auto">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('lg-banners.store') }}" class="needs-validation" novalidate method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group position-relative">
                                <label for="validationTooltip03">Banner Title</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group position-relative">
                                <label for="validationTooltip03">Banner sub header</label>
                                <input name="sub_title" type="text" class="form-control" id="validationTooltip03"
                                    placeholder="Banner sub header" required>
                                <div class="invalid-tooltip">
                                    Please provide a valid Banner sub header.
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                <div class="table table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $loop->index + 1 }}</td>
                            <td><strong>{{ ucfirst($banner->title) }}</strong></td>
                            <td><strong>{{ ucfirst($banner->sub_title) }}</strong></td>
                            <td><strong>{{ $banner->link }}</strong></td>
                            <td>
                                <img src="{{ asset('uploads/lg_banners') }}/{{ $banner->image }}" alt="not found"
                                    width="100">
                            </td>
                            <td>
                                <a href="{{ route('lg-banners.delete', $banner->id) }}"><i class="text-danger fas fa-trash"></i></a>
